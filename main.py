...
# Middleware de autenticación personalizado (debe ir después de las sesiones)
app.add_middleware(
    AuthMiddleware,
    excluded_paths=settings.PUBLIC_PATHS + ["/static", "/docs", "/redoc", "/openapi.json"]
)

# Middleware para mejorar sesiones con información de contexto (después de auth)
...
logger.info("Fin de rutas registradas")
